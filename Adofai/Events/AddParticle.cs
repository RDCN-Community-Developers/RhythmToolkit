namespace RhythmBase.Adofai.Events
{
	...
	/// </summary>
	public class AddParticle : BaseEvent, IStartEvent
	{
		/// <inheritdoc/>
		...
		/// </summary>
		public ValueRange VelocityLimitOverLifetime { get; set; } = new ValueRange(10);
		...
		/// </summary>
		public RDSizeN ParticleSize { get; set; } = new RDSizeN(1, 1);

		/// <summary>
		/// Gets or sets the velocity range of the particles in the X and Y directions.
		/// </summary>
		public ValueRangePair Velocity { get; set; } = new ValueRangePair();
		...
		/// </summary>
		public float ShapeRadius { get; set; } = 0;
		...
		/// </summary>
		public float SimulationSpeed { get; set; } = 0;
