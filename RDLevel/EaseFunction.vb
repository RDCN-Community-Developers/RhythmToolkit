...
Public Module Ease
	...
	Private Class EaseFunction
		...
		End Function
	End Class
	Public Function Ease(x As single, Optional Type As EaseType = EaseType.Unset) As single
		Select Case Type
			Case EaseType.Unset
		...
		End Select
	End Function
	Public Function Ease(x As single, from As single, [to] As single, Optional Type As EaseType = EaseType.Unset) As single
		Return Ease(x, Type) * ([to] - from) + from
	End Function
End Module