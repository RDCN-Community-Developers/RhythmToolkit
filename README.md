...
xychart
  title "Read Time"
    ...
    line [7134.5801,2236.0677,2063.2343,2106.4128,1999.3797,2237.3778,1939.453,1916.7111,1880.1355,1943.7469]
    %% RDTK .NET 8.0 v1.3.4
    ...
    line [3317.9543,1981.8849,1643.5074,1516.5513,1333.5835,1370.9584,1416.6815,1316.2952,1358.4216,1442.6675]
```
...
xychart
  title "Write Time"
    ...
    %% RDTK .NET Standard 2.0 v1.3.10
    line [957.9152,400.5677,455.1585,407.3626,502.6389,368.7282,353.2296,318.1908,301.9918,353.8679]
    %% RDTK .NET 8.0 v1.3.4
    ...
    %% RDTK .NET 8.0 v1.3.10
    line [698.7611,484.2373,178.4038,197.1148,184.9861,173.7393,165.887,198.4509,166.2143,178.2211]
```
