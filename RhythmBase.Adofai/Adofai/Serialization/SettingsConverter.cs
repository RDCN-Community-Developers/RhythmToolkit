...
internal class SettingsConverter : MetadataJsonConverter<Settings>
{
	public override Settings? Read(ref Utf8JsonReader reader, Type typeToConvert, MetadataJsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
		{
			...
			if (reader.ValueTextEquals("version"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("separateCountdownTime"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("previewIcon"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("previewSongStart"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("levelDesc"u8) && reader.Read())
				settings.LevelDesc = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("levelTags"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("speedTrialAim"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("requiredMods"u8) && reader.Read())
			{
				JsonException.ThrowIfNotMatch(ref reader, JsonTokenType.StartArray);
				while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
					settings.RequiredMods.Add(reader.GetString() ?? string.Empty);
			}
			else if (reader.ValueTextEquals("songFilename"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("hitsound"u8) && reader.Read())
				settings.Hitsound = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("hitsoundVolume"u8) && reader.Read())
				settings.HitsoundVolume = reader.GetInt32();
			else if (reader.ValueTextEquals("countdownTicks"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("trackColorAnimDuration"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("trackPulseLength"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("trackTexture"u8) && reader.Read())
				settings.TrackTexture = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("trackTextureScale"u8) && reader.Read())
				settings.TrackTextureScale = reader.GetInt16();
			else if (reader.ValueTextEquals("trackGlowIntensity"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("beatsAhead"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("beatsBehind"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("showDefaultBGIfNoImage"u8) && reader.Read())
				settings.ShowDefaultBGIfNoImage = reader.GetBoolean();
			else if (reader.ValueTextEquals("showDefaultBGTile"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("bgImage"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("parallax"u8) && reader.Read())
				settings.Parallax = TypeConverterRegistry.Read<PointNI>(ref reader, options);
			...
			else if (reader.ValueTextEquals("imageSmoothing"u8) && reader.Read())
				settings.ImageSmoothing = reader.GetBoolean();
			else if (reader.ValueTextEquals("lockRot"u8) && reader.Read())
				settings.LockRot = reader.GetBoolean();
			else if (reader.ValueTextEquals("loopBG"u8) && reader.Read())
				settings.LoopBG = reader.GetBoolean();
			else if (reader.ValueTextEquals("scalingRatio"u8) && reader.Read())
				...
				settings.Position = TypeConverterRegistry.Read<PointNI>(ref reader, options);
			else if (reader.ValueTextEquals("rotation"u8) && reader.Read())
				settings.Rotation = reader.GetInt32();
			else if (reader.ValueTextEquals("zoom"u8) && reader.Read())
				settings.Zoom = reader.GetInt32();
			else if (reader.ValueTextEquals("pulseOnFloor"u8) && reader.Read())
				settings.PulseOnFloor = reader.GetBoolean();
			else if (reader.ValueTextEquals("bgVideo"u8) && reader.Read())
				settings.BgVideo = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("loopVideo"u8) && reader.Read())
				settings.LoopVideo = reader.GetBoolean();
			else if (reader.ValueTextEquals("vidOffset"u8) && reader.Read())
				settings.VidOffset = reader.GetInt32();
			else if (reader.ValueTextEquals("floorIconOutlines"u8) && reader.Read())
				settings.FloorIconOutlines = reader.GetBoolean();
			else if (reader.ValueTextEquals("stickToFloors"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("planetEaseParts"u8) && reader.Read())
			...
			else if (reader.ValueTextEquals("congratsText"u8) && reader.Read())
				settings.CongratsText = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("perfectText"u8) && reader.Read())
				settings.PerfectText = reader.GetString() ?? string.Empty;
			else if (reader.ValueTextEquals("legacyFlash"u8) && reader.Read())
				settings.LegacyFlash = reader.GetBoolean();
			else if (reader.ValueTextEquals("legacyCamRelativeTo"u8) && reader.Read())
				settings.LegacyCamRelativeTo = reader.GetBoolean();
			else if (reader.ValueTextEquals("legacySpriteTiles"u8) && reader.Read())
				settings.LegacySpriteTiles = reader.GetBoolean();
			else if (reader.ValueTextEquals("legacyTween"u8) && reader.Read())
				settings.LegacyTween = reader.GetBoolean();
			else if (reader.ValueTextEquals("disableV15Features"u8) && reader.Read())
