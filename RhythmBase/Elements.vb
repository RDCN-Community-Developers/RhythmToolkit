...
#End If
    ...
    Public Structure ExpTemp
        ...
        Public Function TryGetValue() As Single? Implements INumOrExp.TryGetValue
            Return Nothing
        End Function
        Public Shared Widening Operator CType(value As String) As ExpTemp
    ...
    Public Structure NumOrExpPair
        ...
        Public Overrides Function ToString() As String
            Return $"{{{X},{Y}}}"
        End Function
        Public Function TryGetValue() As RDPointTemp
            Return New RDPointTemp(X.TryGetValue, Y.TryGetValue)
        End Function
        Public Shared Widening Operator CType(v As Linq.JArray) As NumOrExpPair
            Return New NumOrExpPair(v(0).ToString, v(1).ToString)
        End Operator
    End Structure
    Public Structure RDPointTemp
        Public X As Single
        Public Y As Single
        ...
        Public Sub New(x As Single, y As Single)
            Me.X = x : Me.Y = y
        End Sub
        Public Shared Narrowing Operator CType(e As RDPointTemp) As SKPointI
            Return New SKPointI(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As SKPoint
            Return New SKPoint(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As RDPointTemp) As SKSizeI
            Return New SKSizeI(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As SKSize
            Return New SKSize(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As RDPointTemp) As System.Drawing.Point
            Return New Drawing.Point(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As System.Drawing.PointF
            Return New Drawing.PointF(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As RDPointTemp) As System.Drawing.Size
            Return New Drawing.Size(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As System.Drawing.SizeF
            Return New Drawing.SizeF(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As RDPointTemp) As (X As Integer, Y As Integer)
            Return (e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As (X As Single, Y As Single)
            Return (e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As (X As Double, Y As Double)
            Return (e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As RDPointTemp) As NumOrExpPair
            Return New NumOrExpPair(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As SKPointI) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As SKPoint) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As SKSizeI) As RDPointTemp
            Return New RDPointTemp(e.Width, e.Height)
        End Operator
        Public Shared Widening Operator CType(e As SKSize) As RDPointTemp
            Return New RDPointTemp(e.Width, e.Height)
        End Operator
        Public Shared Widening Operator CType(e As Drawing.Point) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As Drawing.PointF) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As Drawing.Size) As RDPointTemp
            Return New RDPointTemp(e.Width, e.Height)
        End Operator
        Public Shared Widening Operator CType(e As Drawing.SizeF) As RDPointTemp
            Return New RDPointTemp(e.Width, e.Height)
        End Operator
        Public Shared Widening Operator CType(e As (X As Integer, Y As Integer)) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Widening Operator CType(e As (X As Single, Y As Single)) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As (X As Double, Y As Double)) As RDPointTemp
            Return New RDPointTemp(e.X, e.Y)
        End Operator
        Public Shared Narrowing Operator CType(e As NumOrExpPair) As RDPointTemp
            Return New RDPointTemp(e.X.TryGetValue, e.Y.TryGetValue)
        End Operator
        Public Shared Operator +(e1 As RDPointTemp) As RDPointTemp
            Return e1
        End Operator
        Public Shared Operator -(e1 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(-e1.X, -e1.Y)
        End Operator
        Public Shared Operator +(e1 As RDPointTemp, e2 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(e1.X + e2.X, e1.Y + e2.Y)
        End Operator
        Public Shared Operator -(e1 As RDPointTemp, e2 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(e1.X - e2.X, e1.Y - e2.Y)
        End Operator
        Public Shared Operator *(e1 As RDPointTemp, e2 As Single) As RDPointTemp
            Return New RDPointTemp(e1.X * e2, e1.Y * e2)
        End Operator
        Public Shared Operator \(e1 As RDPointTemp, e2 As Single) As RDPointTemp
            Return New RDPointTemp(e1.X \ e2, e1.Y \ e2)
        End Operator
        Public Shared Operator /(e1 As RDPointTemp, e2 As Single) As RDPointTemp
            Return New RDPointTemp(e1.X / e2, e1.Y / e2)
        End Operator
        Public Shared Operator Mod(e1 As RDPointTemp, e2 As Single) As RDPointTemp
            Return New RDPointTemp(e1.X Mod e2, e1.Y Mod e2)
        End Operator
        Public Shared Operator *(e1 As RDPointTemp, e2 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(e1.X * e2.X, e1.Y * e2.Y)
        End Operator
        ...
        Public Shared Operator /(e1 As RDPointTemp, e2 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(e1.X / e2.X, e1.Y / e2.Y)
        End Operator
        Public Shared Operator Mod(e1 As RDPointTemp, e2 As RDPointTemp) As RDPointTemp
            Return New RDPointTemp(e1.X Mod e2.X, e1.Y Mod e2.Y)
        End Operator
        Public Shared Operator =(e1 As RDPointTemp, e2 As RDPointTemp) As Boolean
            Return e1.X = e2.X AndAlso e1.Y = e2.Y
        End Operator
        Public Shared Operator <>(e1 As RDPointTemp, e2 As RDPointTemp) As Boolean
            Return e1.X <> e2.X OrElse e1.Y <> e2.Y
        End Operator
        Public Function MultipyByMatrix(matrix(,) As Single) As RDPointTemp
...
X * matrix(0, 1) + Y * matrix(1, 1))
        ...
        End Function
        Public Function Rotate(angle As Single) As RDPointTemp
...
{-Math.Sin(angle), Math.Cos(angle)}
        ...
        End Function
        Public Function Rotate(pivot As RDPointTemp, angle As Single) As RDPointTemp
...
Namespace LevelElements
    ...
    Public Class Decoration
        ...
        <JsonProperty("id")> Public Property Id As String
            ...
            End Set
        End Property
        <JsonIgnore> Public ReadOnly Property Size As RDPointTemp
            Get
                Return If(File?.Size, New RDPointTemp(32, 31))
            End Get
        End Property
