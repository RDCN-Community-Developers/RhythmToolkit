	...
	where TBeat : struct, ITickTime<TBeat>
{
	...
	static abstract TSelf FromStream(Stream stream, LevelReadConfig? settings = null);
	/// <summary>
	...
	static abstract Task<TSelf> FromStreamAsync(Stream stream, LevelReadConfig? settings = null, CancellationToken cancellationToken = default);
	/// <summary>
	...
	static abstract TSelf FromFile(string filepath, LevelReadConfig? settings = null);
	/// <summary>
	...
	static abstract Task<TSelf> FromFileAsync(string filepath, LevelReadConfig? settings = null, CancellationToken cancellationToken = default);
#endif
	/// <summary>
	...
	void SaveToFile(string filepath, LevelWriteConfig? settings = null);
	/// <summary>
	...
	/// <param name="settings">Optional settings for writing the chart. If null, default settings are used.</param>
	/// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
	Task SaveToFileAsync(string filepath, LevelWriteConfig? settings = null, CancellationToken cancellationToken = default);
	/// <summary>
	...
	/// <param name="settings">Optional settings for writing the chart. If null, default settings are used.</param>
	void SaveToStream(Stream stream, LevelWriteConfig? settings = null);
	/// <summary>
	...
	/// <param name="settings">Optional settings for writing the chart. If null, default settings are used.</param>
	/// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
	Task SaveToStreamAsync(Stream stream, LevelWriteConfig? settings = null, CancellationToken cancellationToken = default);
#if NET8_0_OR_GREATER
	/// <summary>
	...
	static abstract TSelf FromJsonDocument(JsonDocument jsonDocument, LevelReadConfig? settings = null);
	/// <summary>
	...
	static abstract TSelf FromJsonString(string json, LevelReadConfig? settings = null);
#endif
	/// <summary>
	...
	JsonDocument ToJsonDocument(LevelWriteConfig? settings = null);
	/// <summary>
	...
	string ToJsonString(LevelWriteConfig? settings = null);
}
/// <summary>
		...
		where TChart : IChart
{
	...
	void SaveToDirectory(string directoryPath, LevelWriteConfig? settings = null);
	/// <summary>
	...
	/// <param name="settings">Optional settings for writing the level. If null, default settings are used.</param>
	/// <param name="cancellationToken">A cancellation token to observe while waiting for the task to complete.</param>
	Task SaveToDirectoryAsync(string directoryPath, LevelWriteConfig? settings = null, CancellationToken cancellationToken = default);
#if NET8_0_OR_GREATER
	/// <summary>
	...
	static abstract TSelf FromDirectory(string directoryPath, LevelReadConfig? settings = null);
	/// <summary>
	...
	/// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
	/// <returns>A task that represents the asynchronous operation. The task result contains the loaded <typeparamref name="TSelf"/> instance.</returns>
	static abstract Task<TSelf> FromDirectoryAsync(string directoryPath, LevelReadConfig? settings = null, CancellationToken cancellationToken = default);
#endif
}
/// <summary>
...
where TChart : IChart
{
	...
	static abstract TSelf FromZip(string filepath, LevelReadConfig? settings = null);
	/// <summary>
	...
	static abstract Task<TSelf> FromZipAsync(string filepath, LevelReadConfig? settings = null, CancellationToken cancellationToken = default);
	/// <summary>
	...
	static abstract Task<TSelf> FromZip(Stream stream, LevelReadConfig? settings = null);
	/// <summary>
	...
	static abstract Task<TSelf> FromZipAsync(Stream stream, LevelReadConfig? settings = null, CancellationToken cancellationToken = default);
#endif
	/// <summary>
	...
	void SaveToZip(string filepath, LevelWriteConfig? settings = null);
	/// <summary>
	...
	Task SaveToZipAsync(string filepath, LevelWriteConfig? settings = null, CancellationToken cancellationToken = default);
	/// <summary>
	...
	/// <param name="settings">Optional settings that control how the level and its assets are serialized. If null, default settings are used.</param>
	void SaveToZip(Stream stream, LevelWriteConfig? settings = null);
	/// <summary>
	...
	Task SaveToZipAsync(Stream stream, LevelWriteConfig? settings = null, CancellationToken cancellationToken = default);
}
