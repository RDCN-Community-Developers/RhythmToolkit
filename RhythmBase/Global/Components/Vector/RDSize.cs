...
public struct RDSize(float? width, float? height) : IRDVector<RDSize, RDSize, float?>
{
	...
	/// </summary>
	/// <remarks>This conversion enables concise and readable initialization of <see cref="RDSize"/> instances from tuples,
	...
	public static implicit operator RDSize((float? width, float? height) tuple) => new(tuple.width, tuple.height);
	/// <summary>
