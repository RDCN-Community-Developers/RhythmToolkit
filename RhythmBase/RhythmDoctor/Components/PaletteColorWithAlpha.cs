...
public struct PaletteColorWithAlpha
{
	...
	/// <inheritdoc/>
	public override readonly string ToString() => EnablePanel ? $"[{_panel}][?]" : "[-]" + Value.ToString("#AARRGGBB");
	/// <summary>
	...
	public static implicit operator PaletteColorWithAlpha(RDColor color) => new(color);
	private int _panel;
