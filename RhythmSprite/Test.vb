...
Module Test
	Sub Main(args As String())
		Dim A = Sprite.FromPath("")
		Dim B = Sprite.FromPath("")
	...
	Sub SubMain2(args As String())
		...
		Dim A = Sprite.FromImage(LoadImage("C:\Users\30698\OneDrive\ÎÄµµ\rdlevels\Characters\Yindoubai.png"), New Numerics.Vector2(32, 56), ImageInputOption.VERTICAL)
	...
	Sub SubMain1(args As String())
		...
		Dim A = Sprite.FromPath(GlobalSettings("readFile"))
