Imports System
Imports Sprite
Imports Sprite.RhythmSprite.Converters
Module Program
	Sub Main(args As String())
		Dim A = RhythmSprite.Sprite.ReadJson("")
		Dim B = RhythmSprite.Sprite.ReadJson("")

	End Sub
	Sub SubMain2(args As String())
		Dim Sets As New RhythmSprite.SpriteOutputSettings With {
			.OutputMode = RhythmSprite.SpriteOutputSettings.OutputModes.PACKED,
			.Sort = True,
			.OverWrite = True,
			.WithImage = True
		}
		...
		Dim A = RhythmSprite.Sprite.FromImage(New Drawing.Bitmap("C:\Users\30698\OneDrive\ÎÄµµ\rdlevels\Characters\Yindoubai.png"), New Numerics.Vector2(32, 56), RhythmSprite.ImageInputOption.VERTICAL)
		For i = 0 To A.Images.Count - 1 Step 8
			If (i / 8 \ 4) >= 4 Then
				Continue For
			End If
			A.Clips.Add(New RhythmSprite.Sprite.Clip With {
						...
						.[Loop] = RhythmSprite.LoopOption.onBeat,
						.LoopStart = 0,
	...
	Sub SubMain1(args As String())
		...
		Dim sets As RhythmSprite.SpriteOutputSettings = GlobalSettings("settings").ToObject(Of RhythmSprite.SpriteOutputSettings)(Setting)
		Dim A = RhythmSprite.Sprite.ReadJson(GlobalSettings("readFile"))
		If GlobalSettings("write") Then
			A.WriteJson(GlobalSettings("writeFile"))
		End If
