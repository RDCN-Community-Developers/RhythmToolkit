...
Module Program
	Sub Main(args As String())
		...
		'Next
		Dim Calculator As New RhythmBase.BeatCalculator(Level)
		...
		For time = 0 To 182 Step 0.1
			For index = 0 To Level.Decorations.Count - 1
				...
				mv.Position = (CType(Nothing, Double?), frame((frame.Length - 1) * index / 100) / max)
				mv.Duration = 1.5
				mv.Ease = RhythmBase.EaseType.InOutSine
				Level.add(mv)
			Next
