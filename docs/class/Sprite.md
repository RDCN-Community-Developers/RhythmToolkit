...
static | [Sprite]() | FromImage(SKBitmap img, Numerics.Vector2 size, [ImageInputOption](../enum/Assets.ImageInputOption.md) inputMode = [ImageInputOption](../enum/Assets.ImageInputOption.md).HORIZONTAL) | 返回从此图片文件构建的一个新 [Sprite]() 实例。
